...
function Geolocation() {
  ...
  const fetchforecast = async () => {
    try {
      ...
      //fecha del pronostico
      setForecastDate(
        resforecast.data.list[7].dt_txt.substring(8, 10) +
          "/" +
          resforecast.data.list[7].dt_txt.substring(5, 7) +
          "/" +
          resforecast.data.list[7].dt_txt.substring(0, 4)
      );
      setForecastDate2(
        resforecast.data.list[15].dt_txt.substring(8, 10) +
          "/" +
          resforecast.data.list[15].dt_txt.substring(5, 7) +
          "/" +
          resforecast.data.list[15].dt_txt.substring(0, 4)
      );
      setForecastDate3(
        resforecast.data.list[23].dt_txt.substring(8, 10) +
          "/" +
          resforecast.data.list[23].dt_txt.substring(5, 7) +
          "/" +
          resforecast.data.list[23].dt_txt.substring(0, 4)
      );
      setForecastDate4(
        resforecast.data.list[31].dt_txt.substring(8, 10) +
          "/" +
          resforecast.data.list[31].dt_txt.substring(5, 7) +
          "/" +
          resforecast.data.list[31].dt_txt.substring(0, 4)
      );
      setForecastDate5(
        resforecast.data.list[39].dt_txt.substring(8, 10) +
          "/" +
          resforecast.data.list[39].dt_txt.substring(5, 7) +
          "/" +
          resforecast.data.list[39].dt_txt.substring(0, 4)
      );
      //Descripcion del pronostico
      ...
      setIconForecast2(
        url + resforecast.data.list[15].weather[0].icon + ".png"
      );
      setIconForecast3(
        url + resforecast.data.list[23].weather[0].icon + ".png"
      );
      setIconForecast4(
        url + resforecast.data.list[31].weather[0].icon + ".png"
      );
      setIconForecast5(
        url + resforecast.data.list[39].weather[0].icon + ".png"
      );
    } catch (err) {
      console.error(err);
    }
      ...
      <div className="container">
        ...
        <div className="columns">
          ...
          <div className="col_2">
            ...
            <div className="Forecast-icon">
              <img src={IconForecast2} alt="icon" />
              {DescForecast2}
            </div>
            <p>{TempForecast2}°C</p>
          </div>
          ...
          <div className="col_3">
            ...
            <div className="Forecast-icon">
              <img src={IconForecast3} alt="icon" />
              {DescForecast3}
            </div>
            <p>{TempForecast3}°C</p>
          </div>
          ...
          <div className="col_4">
            ...
            <div className="Forecast-icon">
              <img src={IconForecast4} alt="icon" />
              {DescForecast4}
            </div>
            <p>{TempForecast4}°C</p>
          </div>
          ...
          <div className="col_5">
            ...
            <div className="Forecast-icon">
              <img src={IconForecast5} alt="icon" />
              {DescForecast5}
            </div>
            <p>{TempForecast5}°C</p>
          </div>
